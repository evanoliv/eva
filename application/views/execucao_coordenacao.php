...
<div class="container-fluid">
	<div class="row">
		...
		<div id="conteudo">
							...
							<?php foreach ($participacoes as $participacao):?>
								<?php if($participacao->apr_data == $dia->selected_date):?>
									...
									<tr>
										...
										<td><a href="<?=base_url()?>execucao/editarParticipacao/<?=$participacao->par_id?>/coordenacao"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a></td>
			...
			<?php endforeach;?>
			<a href="<?=base_url()?>execucao/novoParticipacao/coordenacao"><button class="btn btn-primary">Nova participação</button></a>
